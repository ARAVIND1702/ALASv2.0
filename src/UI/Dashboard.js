...
changeMultipleCSS() {
  ...
  const myStyles = `
   background: linear-gradient(225deg, #1f1d1d, #242222);
   box-shadow:  -21px 21px 45px #191818,21px -21px 45px #2b2828;
  `;
  const element = document.querySelector('.wrap');
  
  element.style.cssText = myStyles;
  document.querySelector('.square-lg').style = myStyles;
  document.querySelector('.oval-lg ').style.cssText = myStyles;
  document.querySelector('.oval-lg--with-icon').style.cssText = myStyles;
  document.querySelector('.oval-xlg').style.cssText = myStyles;
  document.querySelector('.oval-lg spaced-container').style.cssText = myStyles;
     
  document.querySelector(".icon-btn").style.cssText = myStyles;
...
<div class="wrap">
  <div class="gride">
    <button class="square-lg" onClick={this.changeMultipleCSS}>
    ...
    <div class="spaced-container">
      ...
      <button class="icon-btn" style={{right:"-98px"}}>
        <svg class="icon-btn__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
    ...
    <button class="oval-lg" value={1} style={{left:"-195px",top:"241px"}} onClick={this.Intesity}>LOW</button>
    ...
    <button style={{left:"60px",width:"83px",top:"-78px"}} class="oval-sm spaced-container"><span></span>
    ...
    <button class="oval-lg spaced-container" style={{left:"-196px",top:"81px"}} value={this.state.HighBeam}  onClick={this.Intesity}><span style={{paddingLeft:"48px"}}>HIGH</span>
      <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40">
